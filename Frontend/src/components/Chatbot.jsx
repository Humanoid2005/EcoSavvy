 ...
 <div className="fixed bottom-8 right-8 z-50">
          {showChat ? (
            <div className="bg-[#f2f2f2] rounded-xl shadow-2xl w-[400px]">
              <div className="p-4 border-b border-[#0D9488] flex justify-between items-center bg-[#0D9488] rounded-t-xl">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-full bg-[#f2f2f2] flex items-center justify-center">
                    <span className="text-[#0D9488] text-xl font-bold"><img src="/images/ai-bot.png" className="rounded"/></span>
                  </div>
                  <div>
                    <h3 className="font-bold text-[#f2f2f2]">Eco Assistant</h3>
                    <p className="text-sm text-[#f2f2f2]/80">Here to help you save money by becoming eco-friendly</p>
                  </div>
                </div>
                <button 
                  onClick={() => setShowChat(false)}
                  className="text-[#f2f2f2] hover:text-[#16A34A] transition-colors"
                >
                  <X className="w-6 h-6" />
                </button>
              </div>
              
              <div className="h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-[#0D9488] scrollbar-track-gray-100">
              ...
              <div className="p-4 border-t border-gray-200">
                <form onSubmit={handleChatSubmit}>
                  <div className="flex space-x-2">
                    ...
                    <button
                      type="submit"
                      className={`px-6 py-2 rounded-full text-[#000000] transition-colors ${
                        isLoading 
                          ? 'bg-gray-300 cursor-not-allowed' 
                          : 'bg-[#16A34A] hover:bg-[#0D9488] hover:text-[#f2f2f2]'
                      }`}
                      disabled={isLoading}
                    >
            ...
            >
              <div className="w-16 h-16 rounded-full bg-[#16A34A] flex items-center justify-center shadow-xl hover:bg-[#0D9488] transition-colors">
